package com.changan.carbond.config.datasource.source;

import com.alibaba.druid.filter.Filter;
import com.alibaba.druid.pool.DruidDataSource;
import com.changan.carbond.common.MyOffsetLimitInterceptor;
import com.changan.carbond.config.datasource.config.DruidDataSourceUtil;
import com.changan.carbond.config.datasource.config.MybatisConfigurationSupport;
...
@Configuration
@MapperScan(annotationClass = Mapper.class, basePackages = {"com.changan.carbond.spring.mapper"}, sqlSessionFactoryRef = "springSqlSessionFactory")
public class SpringSource {
    ...
    public SqlSessionFactory springSqlSessionFactory(@Qualifier("springDataSource") DruidDataSource dataSource) throws Exception {
        mybatisConfiguration.setTypeAliasesPackage("com.changan.carbond.spring.model");
